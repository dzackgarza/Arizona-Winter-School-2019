...
where we can identify $THH_0, THH_1$ as before and in some sense, the $THH$ are built up out of multiple copies of $HH$. For example, $THH_2$ gets a contribution from $HH_2$ and $THH_0 = HH_0$/