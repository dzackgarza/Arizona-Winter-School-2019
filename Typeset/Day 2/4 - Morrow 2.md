...
We should emphasize at this point that it is not automatic that $TP$ is in fact periodic, as this will not hold for an arbitrary ring. In this case, however, since we have $\FF_p\dash$algebras, we read 2-periodicity off of the spectral sequence.