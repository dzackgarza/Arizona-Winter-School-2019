...
Now similarly, as from Bokstedt's theorem we got a consequence for arbitrary $\FF_p\dash$algebras, we will similarly find some consequence for $TP$ for all $\FF_p\dash$algebras by looking at $TP(\FF_p)$ 
