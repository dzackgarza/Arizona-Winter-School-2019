...
> Major! This holds for an arbitrary $\FF_p\dash$algebra, so you could plug in some singular ring to get a canonical mixed-characteristic lift of $TP$ in the case
