...
So $TP_0$ again contains most of the information, which is a completed filtered ring with associated graded pieces given by $\FF_p[u]. So the question is how we can add up copies of $\FF_p$ in various degrees and end up with a ring.