...
Answer: Every algebra over a field is flat, so they coincide. When taking $HP(\FF_p/\ZZ)$, then they have to be derived -- in general, everything needs to be derived.