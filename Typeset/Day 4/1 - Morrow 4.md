...
Answer: When you plug in a ring, it's not clear, but it does always exist. This is only an affine statement, so does it hold for the case of a projective variety over $\FF_p$