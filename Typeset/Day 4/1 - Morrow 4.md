...
Answer: It doesn't seem like such a claim was made, so what do we mean by "a mixed-characteristic lift"? This means that when you take it derived mod $p$, you recover the RHS, but a priori there's no reason there couldn't also be some $p\dash$torsion in $TP$.