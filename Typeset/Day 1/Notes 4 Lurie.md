...
Let $\bar Y$ be some AG object over an algebraically closed field $k$ with a fixed base point $y\in\bar Y$. We'll later be interested in the case where $k =\overline{\FF_q}$
