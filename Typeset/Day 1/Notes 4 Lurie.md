...
Supposing we only have even dimensional generators, $I/I^2$ is a finite-dimensional $\QQ_\ell$ vector space. So we look at the eigenvalues of $\varphi$ on this once we extend scalars
