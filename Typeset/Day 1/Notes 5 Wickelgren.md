...
So we can write $T_pX \intersect X = L \union Q$. We know that $L \intersect Q$ will be the intersection of a degree 1 and a degree 2 curve, which will have 2 points of intersection. At one of these points, say $x$, $Q$ and $L$ will intersect transversally, and so the tangent vector $T_
