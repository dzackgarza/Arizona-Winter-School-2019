...
At the intermediate stage, we get some information: the $\QQ_\ell$ vector space has a canonical automorphism, namely the Frobenius $\phi_x$ associated to the field $k(x)$.
